...
namespace DoAn
{
    public partial class QLTimKiem : Form
    {
        ...
        private void QLTimKiem_Load(object sender, EventArgs e)
        {
            ...
            this.dgvTimKiem.DefaultCellStyle.Font = new Font("Segoe UI", 12);
            this.dgvTimKiem.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 12);
        ...
        private void dgvTimKiem_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int rowi = e.RowIndex;
            if (rowi < 0 || rowi >= dgvTimKiem.Rows.Count)
            {
                return;
            }
            else
