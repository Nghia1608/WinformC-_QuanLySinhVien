...
namespace Extension.Report.AsposeWordExtension
{
...
/*            int dem = 0;
            ...
            using (SaveFileDialog ofd = new SaveFileDialog() { Filter = "Word Documents|*.doc", ValidateNames = true})
            {
                try
                {
                ...
                {
                    MessageBox.Show("File này đang được sử dụng . Hãy đóng file này ở ứng dụng Word");
                }
